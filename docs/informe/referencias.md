...
- Matriz de pruebas del lexer de Prolog. (2026). [`docs/informe/04_matriz_de_pruebas.md`.] (Evidencia propia: 27 casos válidos, 22 de prioridad, 16 inválidos y resultado real de 86 aprobadas.)
